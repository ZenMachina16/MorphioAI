        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Transform your content for multiple social media platforms with AI-powered repurposing
            </p>
          </div>
        </div>
      </header>
        ...
        <div className="text-center mb-16">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 max-w-2xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Sign in with Google to start repurposing your content for Twitter, Instagram, and LinkedIn
            </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-xl p-6 shadow-lg">
            ...
            <p className="text-gray-600">
              Repurpose content for Twitter, Instagram, and LinkedIn with platform-specific optimizations
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg">
            ...
            <p className="text-gray-600">
              Leveraging Mistral 7B for intelligent content transformation and optimization
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg">
            ...
            <p className="text-gray-600">
              Transform long-form content into multiple social media posts in seconds
            </p>
          </div>
        </div>
      </main>
      ...
      <footer className="bg-white mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-gray-600">
            <p>&copy; 2024 Content Repurposer. Transform your content with AI.</p>
          </div>
        </div>
      </footer>
    </div>
